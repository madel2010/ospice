...
template<>
inline void Dense<std::complex<double> >::multibly_AB_add_this(std::complex<double> Alpha, std::complex<double> Beta, DBase<std::complex<double> >* A, DBase<std::complex<double> >* B){
